      ...
      <div className="sticky top-24 w-full">
        ...
        >
          ...
          <div className="space-y-6 py-4 pb-8">
            ...
            <a href="/road-trip-cost-calculator" className="block">
              <div className="bg-gradient-to-r from-indigo-500 to-purple-600 rounded-xl shadow-lg overflow-hidden border border-indigo-400 hover:shadow-xl transition-all transform hover:-translate-y-1 cursor-pointer">
                <div className="px-6 py-5">
                  <div className="inline-block bg-yellow-400 text-indigo-900 font-bold text-xs px-3 py-1 rounded-full mb-3">UNDER DEVELOPMENT</div>
                  <h3 className="text-xl font-bold text-white mb-2">Road Trip Cost Calculator</h3>
                  <p className="text-indigo-100 text-sm mb-4">Plan your journey, calculate fuel costs, and find routes & hotels with our interactive trip planner. <span className="italic">Some features coming soon!</span></p>
                  <div className="flex items-center justify-between">
                    <span className="inline-flex items-center font-semibold text-white hover:text-yellow-200 text-sm">
                      Try beta version
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                      </svg>
                    </span>
                    <div className="w-12 h-12 flex items-center justify-center bg-indigo-700 rounded-full relative">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7" />
                      </svg>
                      <div className="absolute -top-1 -right-1 h-4 w-4 bg-yellow-400 rounded-full border border-indigo-700 animate-pulse"></div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <a href="/fuel-savings-calculator" className="block">
              <div className="bg-gradient-to-r from-green-500 to-emerald-600 rounded-xl shadow-lg overflow-hidden border border-green-400 hover:shadow-xl transition-all transform hover:-translate-y-1 cursor-pointer">
                <div className="px-6 py-5">
                  ...
                  <div className="flex items-center justify-between">
                    <span className="inline-flex items-center font-semibold text-white hover:text-emerald-200 text-sm">
                      Calculate savings
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                      </svg>
            ...
            <a href="/compare-vehicle-mpg" className="block">
              <div className="bg-gradient-to-r from-blue-500 to-cyan-600 rounded-xl shadow-lg overflow-hidden border border-blue-400 hover:shadow-xl transition-all transform hover:-translate-y-1 cursor-pointer">
                <div className="px-6 py-5">
                  ...
                  <div className="flex items-center justify-between">
                    <span className="inline-flex items-center font-semibold text-white hover:text-blue-200 text-sm">
                      Compare now
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                      </svg>
            ...
            {/* Vehicle MPG Checker */}
            <a href="/vehicle-mpg-checker" className="block">
              <div className="bg-gradient-to-r from-orange-500 to-amber-600 rounded-xl shadow-lg overflow-hidden border border-orange-400 hover:shadow-xl transition-all transform hover:-translate-y-1 cursor-pointer">
                <div className="px-6 py-5">
